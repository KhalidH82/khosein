<template>
  ...
  >
    ...
    <text
      ...
      class="fill-transparent stroke-neutral-200 font-display text-5xl font-bold dark:stroke-neutral-800"
    >
      {{ text }}
    </text>
    ...
    <text
      ...
      :stroke-width="strokeWidth"
      mask="url(#textMask)"
      class="fill-transparent font-display text-5xl font-bold"
    >
      {{ text }}
    </text>
  </svg>
